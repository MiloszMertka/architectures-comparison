...
import com.classic.elearning.course.adapter.dto.AttachCourseMaterialRequest;
import com.classic.elearning.course.adapter.ui.AttachCourseMaterialFormUI;
import com.classic.elearning.course.adapter.ui.presenter.AttachCourseMaterialFormPresenter;
...
public class AttachCourseMaterialFormView extends VerticalLayout implements BeforeEnterObserver, AttachCourseMaterialFormUI {
    ...
    public void navigateToCourseListView() {
        getUI().ifPresent(ui -> ui.navigate(com.classic.elearning.course.infrastructure.view.CourseListView.class));
    }
